...
const EditParty = () => {
  ...
  // Calcular o custo total dos serviços selecionados
  const totalCost = party.services.reduce((acc, curr) => acc + curr.price, 0);

  // Verificar se o custo total excede o orçamento
  if (totalCost > party.budget) {
    useToast("O orçamento é insuficiente para adicionar todos os serviços selecionados.", "error");
    return;
  }
